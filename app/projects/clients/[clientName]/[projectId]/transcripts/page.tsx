...
export default async function ProjectTranscriptsPage({ params }: Readonly<{ params: Promise<{ clientName: string; projectId: string }> }>) {
      ...
      <section className="transcript-workspace">
        <div className="transcript-main-column">
          ...
          <section className="panel transcript-panel">
            ...
            <TranscriptOutputList projectId={projectId} clientName={project.clientName} initialTranscripts={storedTranscripts} />
          </section>
        </div>
