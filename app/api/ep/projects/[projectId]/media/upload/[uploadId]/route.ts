...
/**
 * EditPanel-authenticated (X-EP-Token) chunked upload — CHUNK / ABORT.
 * Mirrors the session-auth /api/projects/:id/media/upload/:uploadId route with
 * an added requireEpToken gate. See the sibling init route for rationale.
 */
