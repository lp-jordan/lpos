...
function DocumentCover({ prospectId, doc, onEdit }: { prospectId: string; doc: ProspectDocument; onEdit: () => void }) {
  ...
  const iconBtn: React.CSSProperties = {
    ...
    borderRadius: 4, fontSize: '0.95rem', lineHeight: 1,
  };
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
      ...
      >
        ...
        <div style={{
          ...
          <button type="button" title={copied ? 'Copied' : 'Copy link'} style={iconBtn} onClick={copyLink}>
            {copied
              ? <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              : <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>}
          </button>
          {info?.exportPdfUrl && (
            <a href={info.exportPdfUrl} target="_blank" rel="noopener noreferrer" title="Export PDF" style={iconBtn} onClick={(e) => e.stopPropagation()}>
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            </a>
          )}
          <button type="button" title="Edit" style={iconBtn} onClick={(e) => { e.stopPropagation(); onEdit(); }}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.1 2.1 0 0 1 3 3L12 15l-4 1 1-4Z"/></svg>
          </button>
        </div>
      </div>
